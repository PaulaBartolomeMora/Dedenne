...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Author data
\newcommand{\myAuthorName}{Paula}
\newcommand{\myAuthorSurname}{Bartolomé Mora}
\newcommand{\myAuthorFullName}{\myAuthorName{} \myAuthorSurname{}}
\newcommand{\myAuthorGender}{female} 
\newcommand{\myAuthorEmail}{p.bartolome@edu.uah.es}
\newcommand{\myAuthorDNI}{09064507-T} 
% Personal details for the anteproyecto request
% Not required in some cases
\newcommand{\myAuthorStreet}{C/ Noruega, 29}
\newcommand{\myAuthorCity}{Villalbilla}
\newcommand{\myAuthorPostalCode}{28810}
\newcommand{\myAuthorProvince}{Madrid}
\newcommand{\myAuthorTelephone}{69509186}
